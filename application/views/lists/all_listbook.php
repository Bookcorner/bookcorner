				...
				<table class="table table-hover">
					...
					<tbody>
        		        <?php foreach ($books as $book):?>
							...
							<td><a href="#" data-name="status" data-type="select" data-pk=""
							...
							<td>
								<div class="btn btn-default deleteBook"
									id="<?= $book['book_id'] ?>">
			...
			<div class="panel-heading">
				...
				<div class="collapse" id="idContentBook<?php echo $book['id']?>">
					<ul id="<?php echo $book['id']?>" class="list-group">
						...
						<li class="list-group-item"><strong>Estado</strong>: <a href="#"
							data-name="status" data-type="select" data-pk=""
							data-url="listbook/updateBookState/<?php echo $book['id']?>"
							data-title="Selecciona un estado"
							data-value="<?php echo $book['val_estado_libro']?>"
							aria-describedBy="<?php echo $book['id']?>"
							class="btn btn-default btn-md"> </a></li>
						<li class="list-group-item"><strong>Puntuación</strong>: <a
							href="#" data-name="score" data-type="select" data-pk=""
							data-url="listbook/updateBookScore/<?php echo $book['id']?>"
							data-title="Puntuación"
							data-value="<?php echo $book['val_puntuacion']?>"
							aria-describedBy="<?php echo $book['id']?>"
							class="btn btn-default btn-md"> </a></li>
						<li class="list-group-item"><strong>Notas</strong>: <a href="#"
							data-name="note" data-type="textarea" data-pk=""
							data-url="listbook/updateBookNote/<?php echo $book['id']?>"
							data-title="Introduce tus notas:"
							data-value="<?php echo $book['val_nota_libro']?>"
							aria-describedBy="<?php echo $book['id']?>"
						...
						<li class="list-group-item"><strong>Eliminar</strong>:
							<div class="btn btn-default deleteBook"
								id="<?= $book['book_id'] ?>">
								<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
							</div></li>
