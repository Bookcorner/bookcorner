...
echo anchor ( base_url ( 'home' ), 'Inicio', [ 
...
echo anchor ( base_url ( 'lista-libros' ), '¡Quiero
...
echo img ( array (
            ...
            'alt' => 'banner crecimiento' 
				...
				<div class="carousel-caption">
					...
					<p>El libro que no encuentres hoy, mañana estará disponible con tu
						ayuda. ¿Nos echas un cable?</p>
					<p class="hidden-xs">
						    <?php
        
echo anchor ( base_url ( 'reportes' ), '¡Quiero ayudar!', [ 
                'class' => 'btn btn-lg btn-primary',
                'role' => 'button' 
        ] )?>
						</p>
...
<div class="row">
	<div class="col-md-7">
		<h2>
			Bookcorner <span class="text-muted"> dedicado única y exclusivamente
				a los libros </span>
		</h2>
		<p class="lead">
...
<div class="row">
	<div class="col-md-7 col-md-push-5">
		...
		<p class="lead">Para ello, te proveemos de la gestión total de los
			...
			conforme a lo que te gustó, como un sistema de notas donde podrás
			apuntar cualquier dato relevante respecto al libro.</p>
	</div>
...
<div class="row">
	<div class="col-md-7">
		...
		<p class="lead">Dado que los libros no paran de salir, es y será (cada
			vez menos) frecuente que el sitio no disponga del libro que quieres
			añadir a tu lista en este momento. Debido a la cantidad ingente de
			libros que hay, os pedimos vuestra ayuda para seguir aumentando el
...
<div class="row">
	<div class="col-md-7 col-md-push-5">
		...
		<p class="lead">Bookcorner te da la posibilidad de ponerle una
			puntuación a los libros de la página. Estas votaciones son recogidas
			de forma anónima, pudiendo así conocer la popularidad de cada uno de
			los libros. Nuestro objetivo es que esta información te ayude a
			descubrir nuevos libros.</p>
	</div>
	<div class="col-md-5 col-md-pull-7">
				<?php
