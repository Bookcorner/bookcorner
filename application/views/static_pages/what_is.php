        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Te damos la bienvenida a Bookcorner: Lugar de gestión de tus libros y autores preferidos.</p>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Gestiona en un lugar centralizado todos los libros que te has leído, y compártelos con tus amigos de forma sencilla.</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">¡Quiero Gestionar mis listas!</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>El contenido dinámico de bookcorner permite que el libro que no encuentres hoy, esté mañana disponible. Para que el sitio crezca, es necesaria tu ayuda. ¿Nos echas un cable?</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">¡Quiero ayudar!</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Comparte tus gustos y opiniones con el resto de la comunidad por medio de los votos de libros y autores</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">¡Quiero votar!</a></p>
            </div>
          </div>
        </div>
      </div>
