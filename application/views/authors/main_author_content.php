	...
	<div class="col-xs-12">
			...
			<div class="panel-body">
				<div class="col-sm-3 col-sm-push-9">
					<a
						href="<?= 'autor/'.filterQuitSpecChar($author->author_fullname) ?>">
    					    <?php
...
echo anchor ( 'autor/' . filterQuitSpecChar ( $author->author_fullname ), $author ['author_fullname'], [ 
                'class' => 'nolink' 
        ] )?>
                        </h2>
...
<div class="row">
	<div class="col-xs-12">
		<div class="panel">
			<div class="panel-body">
				¿No encontraste el autor que buscabas? Ayúdanos añadiendólo a la <a
					href="<?php echo base_url('reportes')?>">base de datos de autores</a>
			</div>
		</div>
	</div>
</div>