	...
	<nav class="navbar navbar-default navbar-inverse hidden-xs">
        ...
        echo img ( array (
			...
			<ul class="nav navbar-nav visible-lg">
				...
				<li
					class="<?php if ($title == 'Lista de libros') { echo 'active'; }?>">
					<a href="<?php echo base_url('lista-libros')?>"> <i
						class="fa fa-list-alt"></i> Lista
				</a>
				</li>
			</ul>
			<!-- MD -->
			<ul class="nav navbar-nav visible-md">
				...
				<li
					class="<?php if ($title == 'Lista de libros') { echo 'active'; }?>">
					<a href="<?php echo base_url('lista-libros')?>"> Lista </a>
				</li>
			</ul>
			<!-- SM -->
			...
			<div class="collapse navbar-collapse navbar-right"
                ...
                echo form_open ( 'busqueda', [ 
					...
					</select> <input type="text" id="idSearchName" name="searchName"
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#"
						class="dropdown-toggle img-responsive contenedor-avatar"
                    ...
                    'class' => 'avatar' 
						...
						<ul class="dropdown-menu" style="padding: 15px; min-width: 150px;">
							...
							<li role="presentation"><a
								href="<?php echo base_url('informacion-de-usuario')?>"
								role="menuitem"> <i class="fa fa-user"></i> Perfil
							</a></li>
							<li role="presentation"><a
								href="<?php echo base_url('reportes')?>" role="menuitem"> <i
									class="fa fa-ambulance"></i> Reportes
							</a></li>
							<li role="presentation"><a
								href="<?php echo base_url('ver-votos')?>" role="menuitem"> <i
									class="fa fa-thumbs-o-up"></i> Votaciones
							</a></li>
							<li role="presentation">
								    <?php if ($role == 2 || $role == 3):?>
								    <a href="<?php echo base_url('moderar')?>" role="menuitem">
									<i class="fa fa-eye"></i> Moderar <span class="badge"><?php echo $number_of_reports?></span>
							</a>
								    <?php endif;?>
								</li>
							...
							<li role="presentation" class="divider"></li>
								<?php if ($role == 3) { ?>
								<li role="presentation"><a href="<?php echo base_url('Admin')?>">
									<i class="fa fa-cog fa-spin"></i> Admin
							</a></li>
								<?php } ?>
								<li><a href="<?php echo base_url('salir')?>"> <i
