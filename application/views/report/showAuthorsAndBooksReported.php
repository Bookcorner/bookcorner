						...
						<table class="table table-hover">
							...
							<tbody>
									...
									<td><a href="#" id="<?= $book['id'] ?>"
										class="btn btn-success acceptBook"> Verificar <i
											class="fa fa-check"></i>
									</a> <a href="#" id="<?= $book['id'] ?>"
										class="btn btn-danger deleteBook"> Rechazar <i
											class="fa fa-times"></i>
									</a></td>
								</tr>    
                    		        <?php endforeach;?>
				...
				<div id="idReportBooksMobile" class="panel-collapse collapse in"
					role="tabpanel" aria-labelledby="headingOne">
						...
						<a class="btn btn-default" data-toggle="collapse"
							...
							aria-expanded="false"
							aria-controls="idContentBook<?php echo $book['id']?>"> Libro </a>
						<div class="collapse" id="idContentBook<?php echo $book['id']?>">
							<ul id="<?php echo $book['id']?>" class="list-group">
								...
								<li class="list-group-item"><strong>Título</strong>: <a href="#"
									data-name="bookname" data-type="text"
									data-pk="<?php echo $book['id']?>"
									data-url="book/updateBookname/<?php echo $book['id']?>"
									data-value="<?php echo $book['book_name']?>"
									aria-describedBy="<?php echo $book['id']?>"
								...
								<li class="list-group-item"><strong>Acciones</strong>: <a
									...
									class="btn btn-success acceptBook"> Verificar <i
										class="fa fa-check"></i>
								</a> <a href="#" class="btn btn-danger deleteBook"
									id="<?= $book['id'] ?> ?>"> Rechazar <i class="fa fa-times"></i>
								</a></li>
							</ul>
						</div>
					</div>
						...
						<table class="table table-hover">
							...
							<tbody>
									...
									<td><a href="#" id="<?= $author['id'] ?>"
										class="btn btn-success acceptAuthor"> Verificar <i
											class="fa fa-check"></i>
									</a> <a href="#" id="<?= $author['id'] ?>"
										class="btn btn-danger deleteAuthor"> Rechazar <i
											class="fa fa-times"></i>
									</a></td>
								</tr>    
                    		        <?php endforeach;?>
				...
				<div id="idReportAuthorsMobile" class="panel-collapse collapse in"
					role="tabpanel" aria-labelledby="headingOne">
						...
						<a class="btn btn-default" data-toggle="collapse"
							...
							aria-expanded="false"
							aria-controls="idContentBook<?php echo $author['id']?>"> Autor </a>
						<div class="collapse" id="idContentBook<?php echo $author['id']?>">
							<ul id="<?php echo $author['id']?>" class="list-group">
								<li class="list-group-item"><strong>Nombre</strong>: <a href="#"
									data-name="authorname" data-type="text"
									data-pk="<?php echo $author['id']?>"
									data-url="author/updateAuthorname/<?php echo $author['id']?>"
									data-value="<?php echo $author['author_fullname']?>"
									aria-describedBy="<?php echo $author['id']?>"
