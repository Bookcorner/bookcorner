					...
					<table class="table table-hover">
        		        ...
        		        <?php foreach ($averageBooks as $book):?>
                            <tr>
								...
								<td>
								    <h3 class="hidden-xs text-center"><?php echo round($book['total'], 2, PHP_ROUND_HALF_DOWN)?> <i class="fa fa-thumbs-o-up"></i></h3>
								    <h5 class="visible-xs text-center"><?php echo round($book['total'], 2, PHP_ROUND_HALF_DOWN)?> <i class="fa fa-thumbs-o-up"></i></h5>
								</td>
								<td>
								    <h3 class="hidden-xs text-center"><?php echo $book['n_usuarios']?> <i class="fa fa-users"></i></h3>
								    <h5 class="visible-xs text-center"><?php echo $book['n_usuarios']?> <i class="fa fa-users"></i></h5>
                                </td>
							</tr>    
        		        <?php endforeach;?>
        		        </tbody>
